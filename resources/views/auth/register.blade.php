...
<a href="{{ route('login') }}" class="flex items-center justify-center rounded-lg h-10 px-5 bg-primary text-slate-900 text-sm font-bold transition-transform hover:scale-105 active:scale-95">
                        Sign In
                    </a>
</div>
</header>
...
<div class="mb-8">
<h3 class="text-2xl font-bold text-slate-900 dark:text-white">Create Account</h3>
<p class="text-slate-500 dark:text-slate-400 mt-1">Start your journey to better colocation</p>
</div>
...
<input name="terms" class="peer h-5 w-5 rounded border-slate-300 dark:border-slate-600 text-primary focus:ring-primary bg-white dark:bg-slate-800" type="checkbox" required>
</div>
